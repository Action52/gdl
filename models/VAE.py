...
class VariationalAutoencoder(Autoencoder):
    def __init__(self, input_dim,
                 ...
                 z_dim, use_batch_norm=False, use_dropout=False, build_=False):
    ...
    def _build(self):
        ...
        x = Flatten()(x)
        # Define layers for mu and log_var for distributions
    ...
    def compile(self, learning_rate, r_loss_factor):
        ...
        def vae_kl_loss(y_true, y_pred):
            kl_loss = -0.5 * K.sum(1 + self.log_var - K.square(self.mu) - K.exp(self.log_var),
                                   axis=1)
            return kl_loss
